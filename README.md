...
Useful tools for developer and people working in IT. [Have a look !](https://it.1devops.io).

## Functionalities and roadmap

Please check the [issues](https://github.com/googlesky/it-tools/issues) to see if some feature listed to be implemented.

You have an idea of a tool? Submit a [feature request](https://github.com/googlesky/it-tools/issues/new/choose)!
...
```sh
docker run -d --name it-tools --restart unless-stopped -p 8080:80 googlesky/it-tools:latest
```

**From github packages:**

```sh
docker run -d --name it-tools --restart unless-stopped -p 8080:80 ghcr.io/googlesky/it-tools:latest
```
...
[![contributors](https://contrib.rocks/image?repo=googlesky/it-tools&refresh=1)](https://github.com/googlesky/it-tools/graphs/contributors)
...
Contributor graph is generated using [contrib.rocks](https://contrib.rocks/preview?repo=googlesky/it-tools).
